...
@Component("laboratorios/detalle-laboratorio-form.pdf")
public class LaboratorioPdfView extends AbstractPdfView {

	@Override
	protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter writer,
			HttpServletRequest request, HttpServletResponse response) throws Exception {
		
		Laboratorio activo = (Laboratorio) model.get("laboratorio");
		Font fuenteTituloPrincipal = FontFactory.getFont("Arial", 18, Color.WHITE);
		PdfPCell celda = null;
		
		PdfPTable tablaTitulo = new PdfPTable(1);
		celda = new PdfPCell(new Phrase("Datos Laboratorio", fuenteTituloPrincipal));
		celda.setBorder(0);
